#ifndef __HASH_UTIL__H__
#define __HASH_UTIL__H__
...
uint64_t murmur3_hash64(const char     *str,
                        const uint32_t &seed1 = 1060627423,
...
uint32_t quick_hash(const void *str, const uint32_t size);
